...
function crearListaEspecialidades(categorias,filtro){
    const contenedorListaCategorias = document.getElementById("containerListaEspecialidades");
    $("#containerListaEspecialidades").empty();
    contenedorListaCategorias.style.marginTop = "25px";
    categorias.forEach(especialidad => {
