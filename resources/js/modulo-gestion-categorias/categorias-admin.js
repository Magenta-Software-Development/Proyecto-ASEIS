...
async function cargarDatos(id) {
    try {
        ...
        $("#inputEditarCategoriaNombre").val(categoria.categoria);
...
function activarCategoria(id){
    $("#btnActivarEspecialidad").off("click").on("click",function (e) { 
        ...
        $.ajax({
            type: "PUT",
            url: "https://springgcp-402821.uc.r.appspot.com/api/categoria/activarCategoria", 
...
function desactivarCategoria(id){
    $("#btnDesactivarCategoria").off("click").on("click",function (e) { 
        ...
        $.ajax({
            type: "PUT",
            url: "https://springgcp-402821.uc.r.appspot.com/api/categoria/desactivarCategoria", 
            contentType: "application/json",
            crossDomain: true,
            data: JSON.stringify(data),
            success: function(response, textStatus, xhr) {
...
function crearListaCategoria(categorias,filtro){
    ...
    if(categorias.length === 0){
        ...
        mensaje.textContent = 'No hay categorias disponibles en este momento.';
        contenedorListaCategorias.appendChild(mensaje);
    }else{
