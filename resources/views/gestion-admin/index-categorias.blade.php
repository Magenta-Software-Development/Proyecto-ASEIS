...
<div class="cuerpoGestion">
    ...
    <div class="modal right" id="creaCategoria" tabindex="-1" aria-labelledby="modal-creaCategorialLabel" aria-hidden="true"> <!-- Modal de crear categoria -->
                    ...
                    <div class="container" style="margin-top: 20%">
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control label-simple" placeholder="Nombre" aria-label="Username" aria-describedby="basic-addon1" id="inputCrearCategoria-Nombre">
                            </div>
                        </div>
                        <br><br>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="2">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button type="button" class="btn btn-primary btn-save ms-5" data-bs-dismiss="modal" aria-label="Close" id="btnCrearCategoria">
                                                    Crear categoría
                                                </button>
                                            </div>
                                        </td>
    ...
    <div class="modal right" id="editarCategoria" tabindex="-1" aria-labelledby="modal-editarCategorialLabel" aria-hidden="true"> <!-- Modal de editar categoria -->
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content ">
                <div class="modal-body">
                    <div class="container" style="margin-top: 20%">
                        <div class="d-flex flex-column align-items-start">
                            <h5 class="letraCategoria ">Nombre categoría</h5>
                            <div class="input-group">
                                <input type="text" class="form-control label-simple" placeholder="Nombre" aria-label="Username" aria-describedby="basic-addon1" id="inputEditarCategoriaNombre">
                            </div>
                        </div>
                        <br><br>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="2">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button type="button" class="btn btn-primary btn-save ms-5" data-bs-dismiss="modal" aria-label="Close" id="btnEditarCategoria">
                                                    Editar categoría
                                                </button>
                                            </div>
                                        </td>
    ...
    <div class="modal right" id="eliminarCategoria" tabindex="-1" aria-labelledby="modal-eliminaCategorialLabel" aria-hidden="true"> <!-- Modal de eliminar categoria -->
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content ">
                <div class="modal-body">
                    <div class="container" style="margin-top: 5%">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <br>
                            <p class="letraEliminar">¿Estas seguro de desactivar la categoría?</p>
                        </div>
                        <br>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="2">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button type="button" class="btn btn-primary btn-eliminar ms-5" data-bs-dismiss="modal" aria-label="Close" id="btnDesactivarCategoria">
                                                    Eliminar
                                                </button>
                                            </div>
                                        </td>
    ...
    <div class="modal right" id="activarEspecialidad" tabindex="-1" aria-labelledby="modal-eliminaCategorialLabel" aria-hidden="true"> <!-- Modal de eliminar categoria -->
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content ">
                <div class="modal-body">
                    <div class="container" style="margin-top: 5%">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <br>
                            <p class="letraEliminar" style="padding-top: 20%">¿Estas seguro de activar la categoria?</p>
                        </div>
                        <br>
                        <div class="table-responsive"> <!-- Tabla de eliminar categoria -->
                            <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="2">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button type="button" class="btn btn-primary btn-activar ms-5" data-bs-dismiss="modal" aria-label="Close" id="btnActivarEspecialidad">
                                                    Activar
                                                </button>
                                            </div>
                                        </td>
