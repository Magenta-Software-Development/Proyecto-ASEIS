...
@section('content')
    ...
    <div id="extralarge-modal" tabindex="-1"
        class="fixed top-0 left-0 right-0 bottom-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto bg-white md:inset-0">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div
                                                                ...
                                                                <button data-modal-target="default-modal"
                                                                    data-modal-toggle="default-modal" class="btnVerMas"
                                                                    type="button">
                                                                    <i class="fa-solid fa-user"></i>
                                                                        ...
                                                                        <div class="modal-content modal-gestion">
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <img src=""
                                                                                        id="img_estudiante" alt="Usuario"
                                                                                        class="img-fluid rounded-circle rounded-image">
                                                                                </div>
                                                                                <h5 class="text-center mt-3 modal-title"
                                                                                    id="nombre_estudiante"></h5>
                                                                                <br>
                                                                                <p class="text-center text-white"
                                                                                    id="estado_estudiante"></p>
                                                                                <br>
                                                                                <p class="text-center text-white"
                                                                                    id="especialidad_estudiante">Estudiante
                                                                                </p>
                                                                                <br>
                                                                                <p class="text-center text-white"
                                                                                    id="correo_estudiante"></p>
                                                                                <br>
                                                                                <p class="text-center text-white"
                                                                                    id="descripcion_estudiante"></p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <button data-modal-target="extralarge-modal2"
                                                                data-modal-toggle="extralarge-modal2" class="estilosBtn"
                                                                type="button">
                                                                <i class="fa-solid fa-user"></i>
                                                            ...
                                                            <div class="col-md-10">
                                                                ...
                                                                <div class="row">
                                                                    <div
                                                                        ...
                                                                        <button class="estilosBtn" id="btnComentarioE"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <button class="estilosBtn" id="btnHabilitarCurso"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modalEliminarComentario">
