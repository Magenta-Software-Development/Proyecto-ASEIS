                    ...
                    <div class="row">
                        <div class="col-md-12">                            
                                <div class="row">                          
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button class="estilosBtn" id="btnHabilitarCurso" data-toggle="modal" data-target="#modalEliminarComentario">
                                            <i class="fa-solid fa-toggle-on"></i><p id="textBtnDesCurso">Habilitar</p>
                                            </button>                                            
                                        </div>
                                        <div class="col-md-6">
                                            <button class="estilosBtn" id="btnEditarCursoNoPublic" data-toggle="modal" data-target="#modalEliminarComentario">
