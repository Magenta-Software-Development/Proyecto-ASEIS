        ...
        <div class="flex flex-col md:flex-row w-10/12 h-3/4">
            ...
            <div class="bg-white md:w-1/2 flex items-center justify-center rounded-2xl">
                ...
                <div class="w-full max-w-lg">
                    ...
                    <div
                        class="mt-7 gap-[19px] font-inter font-[600] inline-flex flex-col items-start text-black text-left [flex-grow:1] w-full">
                        <p class="transition-all text-xl font-semibold">
                            Correo electrónico
                        </p>
                        <input type="text"
                            class="[box-shadow:0px_0px_0px_2px_rgba(121,_121,_121,_1)_inset] [box-shadow-width:2px] w-full h-[60px] rounded-2xl" />
                    </div>
                    <div
                        class="mt-6 gap-[19px] font-inter font-[600] inline-flex flex-col items-start text-black text-left [flex-grow:1] w-full">
                        <p class="transition-all text-xl font-semibold">
                            Contraseña
                        </p>
                        <input type="text"
                    ...
                    <div class="flex gap-[44px] items-center justify-between">
                        <button id="btnLogin" type="submit"
                            class="bg-[#1F76BD] mt-[19px] w-full gap-2.5 flex justify-center items-center rounded-2xl p-[11px] text-white">
                            <p class="text-2xl">
                              Iniciar sesión
                          </p>
                          </button>
