                                        ...
                                        <div class="row medFila">
                                            <div class="col-md-12">
                                                <label for="descripCurso" class="lblmedidaDescrip" id="descripCursoModal">
                                                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat ipsum molestiae sint ab
                                                        ...
                                                        omnis voluptates aspernatur perspiciatis modi enim ad sunt.</p>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 d-flex justify-content-center align-items-center contenedorBotonEC">
                                                                        <button class="estilosBtn" id="btnComentarioE" data-toggle="modal" data-target="#modalEliminarComentario">
                                                                            ...
                                                                            <p id="textBtnComentario">Eliminar Comentario</p>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
