...
@section('css')
    ...
    @vite('resources/css/infoCursosModal.css') <!-- css de la modal de informacion de cursos -->
    @vite('resources/css/modalEliminarDeCursos.css') <!-- css de la modal de eliminar cursos -->
                                                    ...
                                                    <div class="tarjetaEstModal-body">
                                                        ...
                                                        <div class="row">
                                                            <div
                                                                ...
                                                                <a
                                                                    href="{{ route('app_index_ver_alumnos_inscritos_publicados') }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <a
                                                                href="{{ route('app_index_editar_cursoPublicadoDocente') }}">
                                                                <button class="estilosBtn" id="btnEditarCurso"
                                                                    data-toggle="modal"
                                                                    data-target="#modalEliminarComentario">
