...
<body>
    ...
    @section('content')
        ...
        <!-- Botones para abrir modales -->
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-Estudiante">
            Ver Mas
        </button>

        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modal-EstudianteE">
            Editar
        </button>

        <!-- Modal para ver información de usuario -->
        <div class="modal right" id="modal-Estudiante" tabindex="-1" aria-labelledby="modal-DocentelLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content modal-gestion">
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-center align-items-center ">
                            <img src="images/Ellipse_10.png" alt="Usuario"
                                class="img-fluid rounded-circle rounded-image">
                        </div>
                        <h5 class="text-center mt-3 modal-title" id="nameStudent">Elian Treminio Parada</h5>
                        <br>
                        <p class="text-center text-white" id="profesionStudent">Estudiante</p>
                        <br>
                        <p class="text-center text-white" id="emailStudent">TP20007@ues.edu.sv</p>
                        <br>
                        <p class="text-center text-white" id="descripcionStudent">Descripción: Experiencia en programación
                            de aplicaciones móviles en Android estudio
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- Modal para editar información de usuario -->
        <div class="modal right" id="modal-EstudianteE" tabindex="-1" aria-labelledby="modal-DocenteElLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content ">
                    <div class="modal-body">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                <input type="text" class="form-control label-simple"
                                                    placeholder="Nombre" aria-label="UsernameStudent"
                                                    aria-describedby="basic-addon1">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <input type="text" class="form-control label-simple"
                                                    placeholder="Estudiante" aria-label="StudentProfesion"
                                                    aria-describedby="basic-addon1">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <textarea class="form-control label-descripcion" style="width: 100%;" placeholder="Descripcion"
