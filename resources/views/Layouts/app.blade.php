...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('iconoASEIS/logoIcon.ico') }}" type="image/x-icon">
...
<body>
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <button data-drawer-target="logo-sidebar1" data-drawer-toggle="logo-sidebar1" aria-controls="logo-sidebar1" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
    ...
    <!-- SideBar izquierdo -->
    <aside id="logo-sidebar1" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar" style="background-color: white">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800" style="background-color: white">
            <ul class="space-y-2 font-medium" style="padding: 0px;">
                ...
                <li class="bd-links w-100">
                    <a href="{{route('app_index_noticias')}}">
